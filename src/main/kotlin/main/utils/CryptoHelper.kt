...
object CryptoHelper {
    ...
    fun md5(text: String): String {
        return String(encodeHex(md5Bytes(CryptoHelper.getRawBytes(text))))
    }
    ...
    fun sha1(text: String): String {
        return String(encodeHex(sha1Bytes(CryptoHelper.getRawBytes(text))))
    }
    ...
    fun sha256(text: String): String {
        return String(encodeHex(sha256Bytes(CryptoHelper.getRawBytes(text))))
    }
